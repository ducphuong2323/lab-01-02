...
import "bootstrap-icons/font/bootstrap-icons.css"; // nếu bạn dùng class "bi bi-..."
          ...
          <div className="orchid-grid">
            {filteredData.map((item) => (
              <Orchids
                ...
                isNatuaral={item.isNatuaral}  // giữ đúng field bạn đang dùng
                image={item.image}
                color={item.color}
                numberOfLike={item.numberOfLike}
                origin={item.origin}
                category={item.category}
                onViewDetail={() => openModal(item)}
              />
            ))}
          </div>
        </div>
